...
export const GET: APIRoute = async context => {
  if (!config.features.dynamicOgImage) {
    const screenshot = await readFile(resolve("public/images/windows-proxy-diagnosis.png"));
    return new Response(new Uint8Array(screenshot), { headers: { "Content-Type": "image/png" } });
  }
